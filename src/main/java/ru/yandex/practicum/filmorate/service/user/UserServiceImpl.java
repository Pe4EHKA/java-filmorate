...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(@Qualifier("userDbStorage") UserRepository userRepository,
    ...
    public Collection<User> getMutualFriends(long userId, long friendId) {
        ...
        Collection<Long> mutualFriends = friendshipRepository.getMutualFriends(userId, friendId);
